...
class PassportOcrServiceTests(TestCase):
    ...
    def test_extract_passport_data_from_document_parses_mrz(self, mock_extract_images, mock_collect_lines):
        ...
        self.assertEqual(fields.get("passport_number"), "AB1234567")
        self.assertEqual(fields.get("passport_issuing_country"), "BRA")
        self.assertEqual(fields.get("nationality"), "BRA")
        self.assertEqual(fields.get("birth_date"), "1990-01-01")
        self.assertEqual(fields.get("passport_expiry_date"), "2032-01-01")
...
class PassportOcrApiTests(TestCase):
    ...
    def test_api_extrair_passaporte_retorna_erro_sem_documento(self):
        response = self.client.post(reverse("system:api_extract_passport"), data={})
    ...
    def test_api_extrair_passaporte_salva_campos_na_sessao_quando_solicitado(self, mock_extract):
        ...
        self.assertEqual(payload["fields"]["passport_number"], "AB1234567")
