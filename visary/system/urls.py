...
urlpatterns = [
    ...
    path("formularios/criar/",views.criar_formulario,name="criar_formulario",),
    path("formularios/listar/",views.listar_formularios,name="listar_formularios",),
    path("formularios/<int:pk>/editar/",views.editar_formulario,name="editar_formulario",),
    path("formularios/<int:pk>/excluir/",views.excluir_formulario,name="excluir_formulario",),
    path("formularios/<int:formulario_id>/perguntas/criar/",views.criar_pergunta,name="criar_pergunta",),
