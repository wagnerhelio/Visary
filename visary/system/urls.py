...
urlpatterns = [
    ...
    path("clientes/<int:cliente_id>/lembretes/criar/",views.criar_lembrete,name="criar_lembrete",),
    path("lembretes/<int:pk>/toggle/",views.toggle_lembrete,name="toggle_lembrete",),
    path("lembretes/<int:pk>/excluir/",views.excluir_lembrete,name="excluir_lembrete",),
    ...
    path("viagens/<int:pk>/trocar-principal/<int:cliente_id>/",views.trocar_principal_viagem,name="trocar_principal_viagem",),
